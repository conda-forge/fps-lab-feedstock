...
Once the `conda-forge` channel has been enabled, `fps-lab` can be installed with:

```
conda install fps-lab
```

It is possible to list all of the versions of `fps-lab` available on your platform with:
